...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="message">
                <p><strong>{{ $solicitante }}</strong> ha solicitado reabrir los registros de beneficiarios del siguiente proyecto:</p>
            </div>

            <div class="project-box">
                <p style="margin:0;font-size:16px;"><strong>{{ $nombreProyecto }}</strong></p>
            </div>
