                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #f1f5f9; border-radius: 6px; margin-bottom: 24px;">
                                <tr>
                                    <td style="padding: 20px;">
                                        ...
                                        <p style="margin: 0 0 20px 0; font-size: 16px; color: #0f172a; font-weight: 600;">{{ $usuario->email }}</p>
                                        
                                        <p style="margin: 0 0 10px 0; font-size: 14px; color: #64748b;">Contraseña Temporal:</p>
                                        <p style="margin: 0; font-size: 20px; color: #10b981; font-weight: bold; letter-spacing: 1px;">{{ $passwordTemporal }}</p>
                                    </td>
                                </tr>
                            </table>
