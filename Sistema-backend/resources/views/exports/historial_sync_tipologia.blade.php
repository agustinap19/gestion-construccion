...
<div class="page-header">
    <div class="page-header-left">
        ...
        <div class="reporte-sub">Beneficiario: {{ $beneficiario->codigo_beneficiario }} — {{ $beneficiario->nombre }} {{ $beneficiario->apellido_paterno }}</div>
    </div>
    ...
    @foreach($historial as $i => $h)
        <div class="entry-header">
            <span style="font-weight:bold; font-size:11px;">
                {{ $h['tipo_anterior_nombre'] }} &rarr; {{ $h['tipo_nuevo_nombre'] }}
            </span>
