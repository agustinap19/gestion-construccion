    ...
    public function run(): void
    {
        ...
        $proyectos = [
            [
                ...
                'presupuesto_referencial'  => 2500000.00,
                'cantidad_unidades'        => 25,
                'cantidad_beneficiarios'   => 25,
                'avance_fisico'            => 45.50,
                'avance_financiero'        => 42.00,
                'fecha_inicio_planificada' => '2026-01-10',
                'fecha_fin_planificada'    => '2026-11-30',
                'fecha_inicio_real'        => '2026-01-15',
                'latitud'                  => -16.540123,
                'longitud'                 => -68.182456,
                'direccion_obra'           => 'Zona Senkata, Distrito 8',
            ],
            [
                'codigo'                   => 'PRJ-2026-0002',
                'nombre'                   => 'Programa Solidario Santa Cruz - Plan 3000',
                'descripcion'              => '40 viviendas TIPO 2 para el programa solidario del FPS.',
                'categoria'                => 'social',
                'estado'                   => 'formulacion',
                'tipo_proyecto_id'         => $tipoSocialUrbano?->id,
                ...
                'responsable_id'           => $adminId,
                'creado_por_id'            => $adminId,
                'presupuesto_referencial'  => 3800000.00,
                ...
                'latitud'                  => -17.821345,
                'longitud'                 => -63.142567,
                'direccion_obra'           => 'Plan 3000, Barrio Nuevo',
            ],
            [
                ...
                'responsable_id'           => $adminId,
                'creado_por_id'            => $adminId,
                'presupuesto_referencial'  => 450000.00,
                'cantidad_unidades'        => 1,
                'avance_fisico'            => 15.00,
                ...
                'latitud'                  => -16.510000,
                'longitud'                 => -68.120000,
                'direccion_obra'           => 'Achumani, Calle 15',
            ],
        ];
