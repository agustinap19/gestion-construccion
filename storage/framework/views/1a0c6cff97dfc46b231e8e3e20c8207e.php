...
<body>
    <div class="header">
        <h1><?php echo e($empresa); ?></h1>
        <h2><?php echo e($titulo); ?></h2>
        <p>Fecha de emisión: <?php echo e($fechaEmision); ?> | Generado por: <?php echo e($generadoPor); ?></p>
    </div>
    ...
    <div class="info-section">
        <table class="info-table">
            <tr>
                ...
                <td>
                    <?php if(isset($filtros['busqueda']) && $filtros['busqueda']): ?>
                        Búsqueda: "<?php echo e($filtros['busqueda']); ?>" &nbsp;&nbsp;
                    <?php endif; ?>
                    <?php if(isset($filtros['categoria_id']) && $filtros['categoria_id']): ?>
                        Categoría ID: <?php echo e($filtros['categoria_id']); ?>

                    <?php endif; ?>
                    <?php if(empty($filtros['busqueda']) && empty($filtros['categoria_id'])): ?>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><strong><?php echo e($item->codigo ?? 'S/C'); ?></strong></td>
                <td><?php echo e($item->nombre); ?></td>
                <td><?php echo e($item->categoria->nombre ?? '—'); ?></td>
                <td class="text-center"><?php echo e($item->unidad_base); ?></td>
                <td class="text-right"><?php echo e(number_format($item->precio_unitario_referencial ?? 0, 2)); ?></td>
                <td class="text-center">
                    <span class="badge"><?php echo e($item->estado ? 'ACTIVO' : 'INACTIVO'); ?></span>
                </td>
            </tr>
    ...
    <div class="footer">
        <?php echo e($empresa); ?> - Sistema ERP Integrado | Página <span class="page-number"></span>
    </div>
</body>
</html>
<?php /**PATH D:\ProyectosWeb\gestion-construccion\resources\views/reportes/biblioteca/items_pdf.blade.php ENDPATH**/ ?>