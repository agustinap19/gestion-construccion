...
<h1>Reporte Fotográfico — <?php echo e($vivienda->beneficiario ? $vivienda->beneficiario->nombre . ' ' . $vivienda->beneficiario->apellido_paterno : 'Sin Asignar'); ?></h1>
<div class="subtitle">
...
<div class="kpi-row">
    <div class="kpi">
        <div class="kpi-val"><?php echo e($fotos->count()); ?></div>
        <div class="kpi-lbl">Total Fotos</div>
    </div>
    <div class="kpi">
        <div class="kpi-val"><?php echo e($fotos->unique(fn($f) => $f->reporte_id)->count()); ?></div>
        <div class="kpi-lbl">Reportes</div>
    </div>
    <div class="kpi">
        <div class="kpi-val"><?php echo e($fotos->unique(fn($f) => $f->reporte?->usuario_id)->count()); ?></div>
        <div class="kpi-lbl">Técnicos</div>
    </div>
    <div class="kpi">
        <div class="kpi-val"><?php echo e($fotos->filter(fn($f) => $f->latitud)->count()); ?></div>
