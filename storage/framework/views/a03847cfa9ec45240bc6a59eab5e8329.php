                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #eff6ff; border-radius: 6px; margin-bottom: 24px; border-left: 4px solid #3b82f6;">
                                <tr>
                                    <td style="padding: 20px;">
                                        ...
                                        <p style="margin: 0 0 16px 0; font-size: 16px; color: #ef4444; font-weight: 600; text-decoration: line-through;"><?php echo e($rolAnterior->nombre_visible); ?></p>
                                        <p style="margin: 0 0 8px 0; font-size: 14px; color: #64748b;">Nuevo rol:</p>
                                        <p style="margin: 0; font-size: 18px; color: #10b981; font-weight: bold;"><?php echo e($rolNuevo->nombre_visible); ?></p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #f1f5f9; border-radius: 6px; margin-bottom: 24px;">
                                <tr>
                                    <td style="padding: 16px;">
                                        ...
                                        <p style="margin: 0; font-size: 14px; color: #334155;"><?php echo e($razon); ?></p>
                                    </td>
                                </tr>
                            </table>
                            <?php endif; ?>
                            ...
                            <p style="color: #94a3b8; font-size: 12px; margin: 0;">
                                Cambio realizado por: <?php echo e($actor->nombre); ?> <?php echo e($actor->apellido_paterno); ?>
...
<?php /**PATH D:\ProyectosWeb\gestion-construccion\resources\views/emails/rol-cambiado.blade.php ENDPATH**/ ?>