    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="details-box">
                ...
                <p><strong>Dispositivo:</strong> <?php echo e($nombreDispositivo); ?></p>
                <p><strong>Dirección IP:</strong> <?php echo e($ip); ?></p>
                <p><strong>Fecha y hora:</strong> <?php echo e(now()->format('d/m/Y H:i:s')); ?></p>
            </div>
...
<?php /**PATH D:\ProyectosWeb\gestion-construccion\resources\views/emails/codigo-otp.blade.php ENDPATH**/ ?>